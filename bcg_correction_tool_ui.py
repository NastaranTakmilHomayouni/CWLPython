def bcg_correction_tool_ui(varargin):
    gui_Singleton = 1
    ...
    @bcg_correction_tool_ui_OpeningFcn

    , ...
    'gui_OutputFcn',


    @bcg_correction_tool_ui_OutputFcn
...
if nargout
    ...
    just
    before
    bcg_correction_tool_ui is made
    visible.
    function
    bcg_correction_tool_ui_OpeningFcn(hObject, eventdata, handles, varargin)
    % This
    function
    has
    no
    ...
    cfg.cwregression.taperingfunction =
...
set(handles.(['edit_' fields{i}]), 'String', func2str(handles.userdata.cfg.cwregression.(fields
{i})));
else
set(handles.(['edit_' fields{i}]), 'String', num2str(handles.userdata.cfg.cwregression.(fields
{i})));
end
end
...
elseif
strcmp(cfg.cwregression.method, 'slidingwindow')
...
elseif
strcmp(cfg.cwregression.method, 'taperedhann')
...
elseif
strcmp(cfg.cwregression.method, 'none')
...
line.
function
varargout = bcg_correction_tool_ui_OutputFcn(hObject, eventdata, handles)
% varargout
cell
array
...
function
edit_srate_Callback(hObject, eventdata, handles)
% hObject
handle
to
edit_srate(see
...
properties.
function
edit_srate_CreateFcn(hObject, eventdata, handles)
% hObject
handle
to
edit_srate(see
...
function
edit_windowduration_Callback(hObject, eventdata, handles)
% hObject
handle
to
edit_windowduration(see
GCBO)
% eventdata
reserved - to
be
...
contents
of
edit_windowduration as text
% str2double(get(hObject, 'String'))
returns
contents
of
edit_windowduration as a
double
...
properties.
function
edit_windowduration_CreateFcn(hObject, eventdata, handles)
% hObject
handle
to
edit_windowduration(see
...
function
edit_delay_Callback(hObject, eventdata, handles)
% hObject
handle
to
edit_delay(see
...
properties.
function
edit_delay_CreateFcn(hObject, eventdata, handles)
% hObject
handle
to
edit_delay(see
...
function
edit_channelinds_Callback(hObject, eventdata, handles)
% hObject
handle
to
edit_channelinds(see
GCBO)
% eventdata
reserved - to
be
...
contents
of
edit_channelinds as text
% str2double(get(hObject, 'String'))
returns
contents
of
edit_channelinds as a
double
...
properties.
function
edit_channelinds_CreateFcn(hObject, eventdata, handles)
% hObject
handle
to
edit_channelinds(see
...
function
edit_regressorinds_Callback(hObject, eventdata, handles)
% hObject
handle
to
edit_regressorinds(see
GCBO)
% eventdata
reserved - to
be
...
contents
of
edit_regressorinds as text
% str2double(get(hObject, 'String'))
returns
contents
of
edit_regressorinds as a
double
...
properties.
function
edit_regressorinds_CreateFcn(hObject, eventdata, handles)
% hObject
handle
to
edit_regressorinds(see
...
function
edit_taperingfunction_Callback(hObject, eventdata, handles)
% hObject
handle
to
edit_taperingfunction(see
GCBO)
% eventdata
reserved - to
be
...
contents
of
edit_taperingfunction as text
% str2double(get(hObject, 'String'))
returns
contents
of
edit_taperingfunction as a
double
...
properties.
function
edit_taperingfunction_CreateFcn(hObject, eventdata, handles)
% hObject
handle
to
edit_taperingfunction(see
...
function
edit_taperingfactor_Callback(hObject, eventdata, handles)
% hObject
handle
to
edit_taperingfactor(see
GCBO)
% eventdata
reserved - to
be
...
contents
of
edit_taperingfactor as text
% str2double(get(hObject, 'String'))
returns
contents
of
edit_taperingfactor as a
double
...
properties.
function
edit_taperingfactor_CreateFcn(hObject, eventdata, handles)
% hObject
handle
to
edit_taperingfactor(see
...
for i=1:numel(fields)
if strcmp(fields{i}, 'taperingfunction')
handles.userdata.cfg.cwregression.(fields
{i}) = str2func(get(handles.(['edit_' fields{i}]), 'String'));
else
handles.userdata.cfg.cwregression.(fields
{i}) = str2num(get(handles.(['edit_' fields{i}]), 'String'));
end
end
...
elseif
get(handles.radiobutton_slidingwindow, 'value');
handles.userdata.cfg.cwregression.method = 'slidingwindow';
elseif
get(handles.radiobutton_taperedhann, 'value');
...
on
button
press in radiobutton_everything.
    function
radiobutton_everything_Callback(hObject, eventdata, handles)
% hObject
handle
to
radiobutton_everything(see
GCBO)
% eventdata
reserved - to
be
